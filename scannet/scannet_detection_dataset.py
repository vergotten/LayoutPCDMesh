...
class ScannetDetectionDataset(Dataset):
    """Dataset for object bounding box regression in ScanNet."""
    def __init__(self, split_set='train', num_points=40000,
        ...
        self.data_path = os.path.join(DATASET_BASE_DIR, config['scannet_train_detection_data'])
        self.data_path_with_planes = os.path.join(DATASET_BASE_DIR, config['scannet_planes'])
        ...
        if split_set == 'all':
            ...
            split_filenames = os.path.join(DATASET_ROOT_DIR, config['meta_data'],
    ...
    def __getitem__(self, idx, **kwargs):
        ...
        vertex_normals = np.load(os.path.join(self.data_path, os.pardir, config['scannet_train_detection_data_normals'],
                                              scan_name) + ".normal.npy")
